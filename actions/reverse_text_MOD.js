...
//---------------------------------------------------------------------
	...
	short_description: "Reverse any text!",
...
action: function(cache) {
    ...
    const reversetext = this.evalMessage(data.split, cache);
    if(!reversetext) {
      console.log("There is no text to reverse, please check your action Reverse Text");
